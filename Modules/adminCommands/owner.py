...
async def ADD_admin(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    log_message = f"<b>New Admins Added:</b>{added_users_info}"
...
async def Remove_admin(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    log_message = f"<b>Admins Removed:</b>{added_users_info}"
...
async def LIST_ADMIN(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    message = f"<b>Current Admins Are:</b>{added_users_info}"
...
async def Refresh(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    message = f"<b>Current Admins Are:</b>{Admin_info}\n\n<b>Current Blocked Users Are:</b> {bloacked_info}"
...
async def BOT_ACTIVATION_MESSAGE(update):
    ...
    start_message = f"<b>Bot Started</b>\n" f"Start Time: <code>{START_TIME}</code>\n"
    await update.bot.send_message(
        chat_id=OWNER_ID, text=start_message, parse_mode="HTML"
    )
